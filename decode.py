...
dials = [
(2, '1212200805060505040201031125152114', '110', 'xor'),
(10, '0505040914200805180501121518040518', '111'),
('q', '2008050609181920091920080512011920', '000'), # maybe 111
('a', '0914200805180501121518040518200805', '001', 'xor'),
('j', '0609181920091920080512011920020505', '010'),
('k', '2605181501140415140523091212020501', '101', 'xor'),
(5, '2403122119092205151808011909201805','011'),
(7, '0709192005180504200801202001160120', '100')
]

keys = [
(2, '072118062412061022', '000', 'wheel'),
(7, '252516251814050803', '001', 'wheel'),
('q', '010721220624181211', '111', 'wheel'),
('j', '241401171021220718', '011', 'wheel'),
(10, '190721181522070621', '101', 'wheel'),
...
(5, '2122060518061805091814040822180717181918010618', '100', 'pi'),
(10, '07210208202121220626220117220601020719020505180107', '010'),
('k', '05020707212205071818010305021514152512220601070522202107', '000', 'pi'),
('j', '161407162107211826220607161407162107211826120721', '110', 'pi')
] # missing: 7, ace

skulls = [
('j', '2614120714241812020817021001', '101', 'e'),
('q', '072114071922011722012014010610180506', '100'),
(7, '05020707212205071818011614011518190801', '000', ''),
('a', '01020714252510210210140117180514051825020607', '', ''),
('k', '031407210601020702190718010518031814071817', '110', 'e'),
...
for (name, suit) in suits:
  ...
  for (binary, (asString, card)) in sorted(cards.items()):
    print('%s %s %s' % (str(card), binary, asString))
